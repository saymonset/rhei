...
public class ReportePagosControlador extends HttpServlet
		implements
			Serializable {
	private static Logger log = Logger.getLogger(ReportePagosControlador.class
			.getName());

	String mensaje = "";

	String reporteConsulta0 = "/jsp/reporteConsulta0.jsp";
