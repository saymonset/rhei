...
<script type="text/javascript" language="JavaScript">
	...
	<script type="text/javascript" src="/rhei/js/controllers/todoUtilesControllers.js"></script>
				...
				<td>
					<table cellspacing="0" cellpadding="0" class="anchoTabla8">
						...
						<c:if test="${not empty mensaje}">
		                    ...
		                    <c:if test="${mensaje=='reporte.utiles.no.solicitud.activas'}">
								<tr>
									<td colspan=1 class=aviso><fmt:message
											key="reporte.utiles.no.solicitud.activas" bundle="${lang}" /></td>
								</tr>
							</c:if>
						...
						<form id="formBuscarDatos" novalidate name="formBuscarDatos" method="post"
							action="/rhei/reporteBecaUtileContrlador?principal.do=outReport">

							<%@ include file="reporteBecaUtile.jsp"%>

			         		 <input type="hidden" name="accion" value="reporteBecaUtile0.jsp" />
